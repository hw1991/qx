...
echo "                                                                "
  ...
  case $N in
    ...
    3) echo -e "\nInstall...CentOS 7\n"; read -s -n1 -p "任意键继续(Press any key to continue...)" ; bash ~/Core_Install.sh -a -v 64 -dd "https://49-89-185-230.d.cjjd20.com:30443/123-266/38b7a047/1662182-0/38b7a047f76f86bc55f5618c28e5390a?v=2&t=1677553255&s=96ceb0e775ce8e09052b35487d164358&filename=CentOS_7.X_x64_Legacy_NetInstallation_Final_v9.8.vhd.gz&d=65d03042" $DebianMirrors $CXTaddLine ;;
