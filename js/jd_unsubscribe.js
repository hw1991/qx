...
===========Loon============
[Script]
cron "55 23 * * *" script-path=https://qxzy.top/rules/QuantumultX/js/zwf234/jd_unsubscribe.js,tag=取关京东店铺商品
============Surge=============
...
===========小火箭========
取关京东店铺商品 = type=cron,script-path=https://qxzy.top/rules/QuantumultX/js/zwf234/jd_unsubscribe.js, cronexpr="55 23 * * *", timeout=3600, enable=true
 */
